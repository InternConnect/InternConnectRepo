    ...
    <>
      ...
      >
        <Tabs.Screen
          name="home"
          options={{
            headerTitle: () => <CustomHeader title="Home" />, // Pass the title "Home"
            headerShown: true,
            tabBarIcon: ({ focused }) => (
        ...
        <Tabs.Screen
          name="search"
          options={{
            headerTitle: () => <CustomHeader title="Search" />, // Pass the title "Search"
            headerShown: true,
            tabBarIcon: ({ focused }) => (
        ...
        <Tabs.Screen
          name="notifications"
          options={{
            headerTitle: () => <CustomHeader title="Notifications" />, // Pass the title "Notifications"
            headerShown: true,
            tabBarIcon: ({ focused }) => (
